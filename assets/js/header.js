// time of scroll winow and change navbar
const navbarElem = document.querySelector("#navbar");
const logoHeaderElem = document.querySelector(".logo-header");

document.addEventListener("scroll", () => {
  navbarElem.classList.add("scrolled");
  logoHeaderElem.style = "width: 65px; transition: 1s;";
  if (document.documentElement.scrollTop === 0) {
    navbarElem.classList.remove("scrolled");
    logoHeaderElem.style = "width: 70px; transition: 1s;";
  }
});
...
const XElemLogin = document.querySelector("#X-login");

const searchBoxBtn = document.querySelector("#searchBtn");
const modalElemSearch = document.querySelector(".my-modal-parent-search");
const XElemSearch = document.querySelector("#X-search");

const offcanvasNavbarElem = document.querySelector("#offcanvasNavbar");
